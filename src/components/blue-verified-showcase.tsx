    ...
    aboutItems: [
      {
        ...
        d: 'Точный год известен **после выдачи** — аккаунт берётся из закрытого пула.',
      },
      {
        tag: 'Профиль',
        t: 'Выдаётся случайный',
        d: 'Ник, аватар и описание **меняете сами** за пару минут.',
      },
      {
        tag: 'Почта',
        t: 'Ящик в комплекте',
        d: 'Коды подтверждения и восстановление — **на вашей стороне**.',
      },
      {
        tag: 'Доступ',
        t: 'Логин, пароль и 2FA',
        d: 'Приходят в чат после оплаты. **Смените пароль** первым делом.',
      },
      {
        tag: 'Галочка',
        t: 'Оплачена на 30 дней',
        d: 'Дальше **продлеваете сами** в настройках X.',
      },
      {
        tag: 'Опт',
        t: 'Партия под задачу',
        d: 'Нужен объём — соберём и отдадим **списком**, напишите в поддержку.',
      },
    ],
    aboutNote:
      'Проверьте вход сразу: замена по гарантии — **48 часов** с момента выдачи.',
    buy: 'Купить',
    ...
    aboutItems: [
      {
        ...
        d: 'The exact year is known **after delivery** — accounts come from a closed pool.',
      },
      {
        tag: 'Profile',
        t: 'Assigned at random',
        d: 'Handle, avatar and bio are **yours to change** in a couple of minutes.',
      },
      {
        tag: 'Mail',
        t: 'Mailbox included',
        d: 'Confirmation codes and recovery **stay on your side**.',
      },
      {
        tag: 'Access',
        t: 'Login, password and 2FA',
        d: 'Sent to chat after payment. **Change the password** first.',
      },
      {
        tag: 'Check',
        t: 'Paid for 30 days',
        d: 'After that you **renew it yourself** in X settings.',
      },
      {
        tag: 'Bulk',
        t: 'Batch on request',
        d: 'Need volume — we collect it and hand over a **list**, just ask support.',
      },
    ],
    aboutNote:
      'Log in right away: warranty replacement is **48 hours** from delivery.',
    buy: 'Buy',
    soldOut: 'Sold out',
  },
}
