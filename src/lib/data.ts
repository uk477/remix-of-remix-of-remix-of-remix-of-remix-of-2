...
export const ACCOUNTS: AgedAccount[] = [
  ...
  },
  {
    ...
    description: {
      en: 'Top-tier blue verified account with an established 1K–5K real audience. Maximum trust.',
      ru: 'Топовый аккаунт с синей галочкой и устоявшейся реальной аудиторией 1K–5K. Максимум доверия.',
      ar: 'حساب موثّق أزرق من الطراز الأول بجمهور حقيقي 1K–5K. أقصى ثقة.',
      zh: '顶级蓝标账号，1K–5K真实粉丝，最高可信度。',
      es: 'Cuenta verificada azul de primer nivel con audiencia real de 1K–5K. Máxima confianza.',
      tr: '1K–5K gerçek kitleye sahip en üst düzey mavi onaylı hesap. Maksimum güven.',
      pt: 'Conta verificada azul topo de linha com audiência real de 1K–5K. Máxima confiança.',
      fr: 'Compte vérifié bleu haut de gamme avec audience réelle 1K–5K. Confiance maximale.',
      uk: 'Топовий акаунт із синьою галочкою та реальною аудиторією 1K–5K. Максимум довіри.',
    },
    yearRange: '2013–2017',
    year: 2016,
    pricePerAccount: 89.0,
    ...
    features: [
      { en: 'Blue checkmark paid', ru: 'Синяя галочка оплачена', ar: 'العلامة الزرقاء مدفوعة', zh: '蓝标已付费', es: 'Check azul pagado', tr: 'Mavi tik ödendi', pt: 'Selo azul pago', fr: 'Badge bleu payé', uk: 'Синя галочка оплачена' },
      { en: '1K–5K followers', ru: '1K–5K фолловеров', ar: '1K–5K متابع', zh: '1K–5K 粉丝', es: '1K–5K seguidores', tr: '1K–5K takipçi', pt: '1K–5K seguidores', fr: '1K–5K abonnés', uk: '1K–5K фолловерів' },
    ],
  },
